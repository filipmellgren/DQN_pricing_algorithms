...
import itertools
# Hyperparameters
MIN_PRICE = 1.613 * (1 - 0.02) # Set such that it is 0.9 of Nash price
MAX_PRICE = 1.732 * (1 + 0.02)  # Set such that it is 1.1 of Monopoly price
...
def actions_dict(nA, a0, mu, firmlist1, firmlist2, action_type):
    ...
    if action_type == "monopoly":
        ...
        raise ValueError('action_type has to be either "monopoly", "nash".')
...
# nash_price = act_to_price(nash_act, nA) * 0.9
# mon_act = monopoly_action(nA, a0, mu, firm0, firm1)
# mon_price = act_to_price(mon_act, nA)*1.1
# =============================================================================
