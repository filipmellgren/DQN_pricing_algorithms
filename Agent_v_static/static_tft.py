...
class Amtft:
    ...
    * "Maintaining cooperation in complex social dilemmas using deep 
    ...
    def reset(self, nA, a0, mu, firm0, firm1, gamma):
        ...
        self.d_act1 = nash_actions[str((firm0, firm1))][1] #best_response(self.c_act1, nA, a0, mu, firm0, firm1)
        self.d_act = 0 # Extra hard punishment introudced
        ...
        self.T = 1*(self.profit1_cd - self.profit1_cc) # Threshold for how much profit gain rival can gather before amTFT punishes
        return
    ...
    def act(self, act1):
        ...
        if self.W > self.T:
            self.b = 1 #self.len_defect() # length of punishment period # TODO: fix this
            self.W = 0
        return(act)
    ...
    def len_defect():
        ...
        # TODO: feb 13th: set threshold better, test punishment
